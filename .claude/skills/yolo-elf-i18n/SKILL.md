...
- UI copy: `static/phone.html`, `static/viewer.html`, `static/history.html`, `static/settings.html`, `static/login.html`, and their paired `.js` files, plus `static/theme.js`.
