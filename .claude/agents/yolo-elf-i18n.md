...
Own user-facing strings in `static/phone.html`, `static/viewer.html`, `static/*.js`, `README.md`, and `TUNING.md`. Keep phone HUD and chip labels short. Use Traditional Chinese when localizing Chinese unless the task specifies another locale.
